...
function makeWebVersions()
{
	...
	foreach ($posts as $post) {
		...
		if (! $prepMode) {  // remove files that don't match anything in the database, unless we're in single-post rendering mode
...
/* if (inStr('hip/core', $thePost['title'])) {
